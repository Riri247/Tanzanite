                    ...
                    <div class="header__nav">
                        <nav class="header__menu mobile-menu">
                            <ul>
								...
								<li class= "Register__block" Visible ="true"><a href="./blog.html"><asp:label ID="Register" runat="server" Text="Register"/></a></li>
								<li class= "Login__block" Visible ="true"><a href="./blog.html"><asp:label ID="Login" runat="server" Text="Login"/></a></li>
									
								<input class="header__searchbox" id="Text1" type="text" placeholder="search..."/>			<!-- place search icon here -->
								</div>
